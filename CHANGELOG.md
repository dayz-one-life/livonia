...
### Deprecated
### Removed
- Custom spawn-gear loadout: deleted `custom/loadout.json` and emptied `spawnGearPresetFiles` in `cfggameplay.json`, so fresh spawns get vanilla default gear again.
### Fixed
### Security
